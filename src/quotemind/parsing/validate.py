"""Extraction validation gate (TASK-034).
...
def validation_reasons(extraction: RFQExtraction) -> list[str]:
    """Reason codes forcing needs_clarification (TASK-034). Empty list means the extraction passes."""
...
def needs_clarification(extraction: RFQExtraction) -> bool:
    """True when the extraction fails the TASK-034 gate and must not proceed to matching."""
